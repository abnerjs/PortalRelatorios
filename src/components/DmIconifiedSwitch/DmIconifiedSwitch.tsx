...
const DmIconifiedSwitch = styled((props: SwitchProps) => (
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& .MuiSwitch-thumb:before': {
        backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" height="20" width="20" preserveAspectRatio="xMidYMid meet" viewBox="-6 -6 48 48"><path fill="${encodeURIComponent(
          '#23ACE6',
  ...
  '& .MuiSwitch-thumb': {
    ...
    '&:before': {
      ...
      backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" height="18" width="18" preserveAspectRatio="xMidYMid meet" viewBox="0 0 12 12"><g fill="none"><path fill="${encodeURIComponent(
          '#aaa',
